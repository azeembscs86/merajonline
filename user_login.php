...
<head>
    ...
    <title>User Login | Create New Customer Account</title>
                                    ...
                                    <div class="account-login">
                                        <div class="page-title">
                                            ...
                                            <div class="row">
                                                ...
                                                <form id="login-form" method="post" action="register-user-login">
                                                <div class="col-sm-6">
                                                    <div class="col2-set">
                                                        <div class="col-2 registered-users">
                                                            <div class="content">
                                                                ...
                                                                <ul class="form-list">
                                                                    <li>
                                                                        <label class="required" for="email"><em>*</em>Email Address/User Name</label>
                                                                        <div class="input-box">
                                                                            <input type="email" title="Email Address" class="input-text required-entry validate-email" id="email" value="" name="email">
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                        ...
                                                        <div class="col-2 registered-users">
                                                            <div class="buttons-set">
                                                                <a class="f-left" href="forgot-password">Forgot Your Password?</a>
                                                                <button id="send2" name="submit" title="Login" class="button" type="submit"><span><span> Submit </span></span></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
