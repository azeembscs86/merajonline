...
<head>
   ...
   function NoOfItemslist(nooflist)
   {
			...
			xhr.open('GET','no_of_item_display.php?hoodieslist='+nooflist,true);
			xhr.send();
 ...
 function Sorting(sortingtype)
   {            
                     var   totaldisplayitemnum = document.getElementById("nolistcount").value;
                        ...
                        xhr =  new XMLHttpRequest();
			xhr.open('GET','sorting-item-page.php?sortingtypeval='+sortingtype+'&totalitemdisplay='+totaldisplayitemnum+'&hoodiessorting=hoodiesproduct',true);
			xhr.send();
                                            ...
                                            <div class="col-main">
                                                ...
                                                <div class="category-products">
                                                    <div class="toolbar">
                                                        ...
                                                        <?php
                                                 $latest_wear_product=getHoodiesProducts();
