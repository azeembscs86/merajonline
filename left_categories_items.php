...
<head>
   ...
   function NoOfItemslist(nooflist,categorytype)
   {
                        xhr =  new XMLHttpRequest();
			xhr.open('GET','left_item_display.php?noofitems='+nooflist+'&category_id='+categorytype,true);
			xhr.send();
...
// Sorting List
 ...
 function Sorting(sortingtype,categorytype)
   {            
                     var totaldisplayitemnum = document.getElementById("nolistcount").value;
                     
                        xhr =  new XMLHttpRequest();
			xhr.open('GET','sorting_left.php?sortingtypeval='+sortingtype+'&totalitemdisplay='+totaldisplayitemnum+'&category_id='+categorytype,true);
			xhr.send();
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="col-main">
                                                ...
                                                <div class="category-products">
                                                 ...
                                                 $latest_wear_product=getLeftCategoryItems($category_type_id);
                                                 ...
                                                 { ?>
                                                        <div class="sorter">
                                                            ...
                                                            <div class="sort-by hidden-xs hidden-sm">
                                                                <label>Sort By</label>
                                                                <select onchange="Sorting(this.value,<?php echo $category_type_id; ?>)">
                                                            ...
                                                            <div class="limiter hidden-xs hidden-sm">
                                                                <label>Show</label>
                                                                <select id="nolistcount"  onchange="NoOfItemslist(this.value,<?php echo $category_type_id; ?>)">
