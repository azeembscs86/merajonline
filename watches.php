...
<head>
   ...
   function NoOfItemslist(nooflist)
   {
			...
			xhr.open('GET','displaywatches.php?girlsitemshow='+nooflist,true);
			xhr.send();
   ...
   {            
                     var   totaldisplayitemnum = document.getElementById("nolistcount").value;
                        xhr =  new XMLHttpRequest();
			xhr.open('GET','sorting-watches.php?sortingtypeval='+sortingtype+'&totalitemdisplay='+totaldisplayitemnum+'&girlsproduct=boyproduct',true);
			xhr.send();
                                            ...
                                            <div class="col-main">
                                                ...
                                                <div class="category-products">
                                                    <div class="toolbar">
                                                         ...
                                                         <?php
                                                $girls_wear_product=getGirlsWearProducts();
                                                 $girls_wear_product_list=  mysql_fetch_array($girls_wear_product);
                                                 if($girls_wear_product_list['product_id'] != '')
                                                 { ?>
                                                        <div class="sorter">
                                                        ...
                                                        <li class="item col-md-3 col-sm-6 col-sms-6 col-smb-12 ">
                                                            <div class="item-inner">
                                                                <div class="box-images">
                                                                    <a class="product-image" title="Product Title 02" href="product-details?productid=<?php echo $girls_wear_product_list['product_id']; ?>">
                                                                ...
                                                                <div class="product-shop">
                                                                    <h2 class="product-name"><a title="Product Title 02" href="product-details?productid=<?php echo $girls_wear_product_list['product_id']; ?>"> <?php echo $girls_wear_product_list['product_name']; ?></a></h2>
