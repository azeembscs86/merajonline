            ...
            <div class="container">
                <div class="container-inner">
                    <div class="main-page">
						...
						?>				
                                        <form id="form-validate" method="post" action="edit-profile">
                                            <div class="row">
                                                <div class="col-sm-2"></div>
                                                <div class="col-sm-8">
                                                    <div class="fieldset">                                                        
                                                        <h2 class="legend">USER PROFILE</h2>
                                                        <?php
                                                            if(isset($_GET['updatepromesage'])){
                                                        ?>
                                                        ...
                                                        <ul class="form-list">
                                                            <li class="fields">
                                                                <div class="customer-name">
                                                                    <div class="field name-firstname">
                                                                        ...
                                                                        <div class="input-box">
                                                                            <input type="text" readonly="" class="input-text required-entry" maxlength="255" title="First Name" value="<?php echo $user_result['firstname']; ?>" name="firstname" id="firstname">
                                                                        </div>
                                                                    </div>
                                                                    <div class="field name-lastname">
                                                                        <label class="required" for="lastname"><em>*</em>Last Name</label>
                                                                        <div class="input-box">
                                                                            <input type="text" readonly="" class="input-text required-entry" maxlength="255" title="Last Name" value="<?php echo $user_result['lastname']; ?>" name="lastname" id="lastname">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                ...
                                                                <div class="input-box">
                                                                    <input type="text"  class="input-text validate-email required-entry" readonly="" value="<?php echo $user_result['email']; ?>" title="Email Address" value="" id="email_address" name="email">
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <label class="required" for="user_name"><em>*</em>User Name</label>
                                                                <div class="input-box">
                                                                    <input type="text" class="input-text validate-email required-entry" title="User Name" readonly="" value="<?php echo $user_result['user_name']; ?>" id="user_name" name="user_name">
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="input-box">
                                                                    <input type="text" class="input-text validate-email required-entry" title="Mobile Number" readonly="" value="<?php echo $user_result['phone_number']; ?>" id="mobile_number" name="mobile_number">
                                                                </div>
                                                            </li>
                                                            <li>
                                                                <label class="required" for="phone_number"><em>*</em>Additional phone number (optional)</label>
                                                                <div class="input-box">
                                                                    <input type="text" class="input-text validate-email required-entry" title="phone number" readonly="" value="<?php echo $user_result['phone_number']; ?>" id="phone_number" name="phone_number">
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="input-box">
                                                                    <textArea readonly="" rows="10" cols="30" name="address"><?php echo $user_result['address']; ?></textArea>                                                                   
                                                                </div>
                                                            </li>
                                                        </ul>
                                                        ...
                                                        <button name="submit" value="Edit"  class="button validation-passed" title="Submit" type="submit"><span><span>Edit</span></span></button>
