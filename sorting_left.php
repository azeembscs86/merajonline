...
$sortingtypeval = $_GET['sortingtypeval'];
$totalitemdisplay = $_GET['totalitemdisplay'];
...
<ul class="products-grid row even">
                                                         ...
                                                         <?php
                                                 $latest_wear_product=sortingLaftCategory($sortingtypeval,$totalitemdisplay,$category_id);
