...
<head>
    ...
    <title><?php echo $web_title;?> New Products</title>
   ...
   function NoOfItemslist(nooflist)
   {
			...
			xhr.open('GET','latestproduct.php?allitemshow='+nooflist,true);
			xhr.send();
 ...
 function Sorting(sortingtype)
   {            
                     var   totaldisplayitemnum = document.getElementById("nolistcount").value;
                        ...
                        xhr =  new XMLHttpRequest();
			xhr.open('GET','sorting-latest-product.php?sortingtypeval='+sortingtype+'&totalitemdisplay='+totaldisplayitemnum+'&newproductsorting=newproduct',true);
			xhr.send();
                                            ...
                                            <div class="col-main">
                                                ...
                                                <div class="category-products">
                                                    <div class="toolbar">
                                                        ...
                                                        <?php
                                                $latest_wear_product=getClothesProductsList();
                                                 ...
                                                 { ?>
                                                        <div class="sorter">
                                                            ...
                                                            <div class="limiter hidden-xs hidden-sm">
                                                                ...
                                                                <option selected="selected" value="900000000000000">
                                                                        All </option>
                                                                    <option  value="10">
                                                                        10 </option>
                                                                    <option value="20">
                                                    ...
                                                    <ul class="products-grid row even">
                                                         ...
                                                         <?php
                                                 $latest_wears_product=getClothesProductsList();
                                                 if($latest_wears_product>0)
                                                 {
                                                     while($latest_wear_product_list=  mysql_fetch_array($latest_wears_product))
                                                     {
                                                ?> 
                                                        ...
                                                        <li class="item col-md-3 col-sm-6 col-sms-6 col-smb-12 ">
                                                            <div class="item-inner">
                                                                <div class="box-images">
                                                                    <a class="product-image" title="Product Title 02" href="product-details?productid=<?php echo $latest_wear_product_list['product_id']; ?>">
                                                                        <img alt="Product Title 02" src="products/product_color/<?php echo $latest_wear_product_list['product_image']; ?>" width="273" height="231">
                                                                    </a>
                                                                ...
                                                                <div class="product-shop">
                                                                    <h2 class="product-name"><a title="Product Title 02" href="product-details?productid=<?php echo $latest_wear_product_list['product_id']; ?>"> <?php echo $latest_wear_product_list['product_name']; ?></a></h2>
