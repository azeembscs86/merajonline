...
<head>
   ...
   function NoOfItemslist(nooflist)
   {
			...
			xhr.open('GET','handbagsdisplay.php?girlsitemshow='+nooflist,true);
			xhr.send();
                                            ...
                                            <div class="col-main">
                                                ...
                                                <div class="category-products">
                                                    <div class="toolbar">
                                                         ...
                                                         <?php
                                                $girls_wear_product=getHandBagsProducts();
                                                            ...
                                                            <div class="item-inner">
                                                                <div class="box-images">
                                                                    <a class="product-image" title="Product Title 02" href="product-details?productid=<?php echo $girls_wear_product_list['product_id']; ?>">
                                                                        <img alt="Product Title 02" src="products/product_color/<?php echo $girls_wear_product_list['product_image']; ?>" width="273" height="231">
                                                                    </a>
