...
if(isset($_GET['newproductsorting']))
    { ?>
        <ul class="products-grid row even">
                                                         ...
                                                         <?php
                                                 $latest_wear_product=sortingClothesLatestProductList($sortingtype,$noofitem);
                                                            ...
                                                            <div class="item-inner">
                                                                <div class="box-images">
                                                                    <a class="product-image" title="Product Title 02" href="#">
                                                                        <img alt="Product Title 02" src="products/product_color/<?php echo $latest_wear_product_list['product_image']; ?>" width="237" height="231">
                                                                    </a>
...
<?php
    ...
    { ?>
        <ul class="products-grid row even">
                                                         ...
                                                         <?php
                                                 $latest_wear_product=sortingJwelleryProductList($sortingtype,$noofitem);
                                                 if($latest_wear_product>0)
                                                 {
                                                     while($latest_wear_product_list=  mysql_fetch_array($latest_wear_product))
                                                     {
