                        ...
                        <div class="main-container col1-layout">
                            <div class="main">
                                    ...
                                    <div class="account-login">
                                        <div class="page-title">
                                            ...
                                            <div class="row">
                                                ...
                                                <form id="login-form" method="post" action="incre_passsword_reset.php">
                                                <div class="col-sm-6">
                                                    <div class="col2-set">
                                                        <div class="col-2 registered-users">
                                                            <div class="content">
                                                                ...
                                                                ?>
                                                                <input type="hidden" class="form-control" name="userId" value="<?php echo $user['user_id']; ?>" />
                                ...
                                <input type="hidden" class="form-control" name="passkey" value="<?php echo $passkey; ?>" />
                                                                <ul class="form-list">
                                                                    <li>
                                                                        <label class="required" for="email"><em>*</em>New Password</label>
                                                                        <div class="input-box">
                                                                            <input type="password" title="Password" class="input-text required-entry validate-email" id="password" value="" name="password">
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <label class="required" for="email"><em>*</em>Confirm Password</label>
                                                                        <div class="input-box">
                                                                            <input type="password" title="Confirm Password" class="input-text required-entry validate-email" id="confirm_password" value="" name="confirm_password">
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                        ...
                                                        <div class="col-2 registered-users">
                                                            <div class="buttons-set">
                                                                <a class="f-left" href="user-login">Login Here</a>
