...
//------------------------Variable for Server name,Database,User name,Password--------------------------------
    $adb ="meraj_online";
    $db_server ="localhost";
    $db_user = "meraj_onlinem";
    $db_password = "DL!~dh@!zvn^";
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where catogry_id=1 order by product_id DESC limit 0,5";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where catogry_id=10 order by product_id DESC limit 0,5";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where catogry_id=9 order by product_id DESC limit 0,5";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where catogry_id=11 order by product_id DESC limit 0,5";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where catogry_id=9 order by product_id DESC";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where catogry_id=11 order by product_id DESC";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where catogry_id=10 order by product_id DESC";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
//---------------------------get male products------------------------------------------------------------
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where product_gender='boys' order by product_id DESC limit 0,5";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
//---------------------------get female products------------------------------------------------------------
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where product_gender='girls' order by product_id DESC limit 0,5";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
{
    $query="select product_id, product_name,product_image,product_price from incre_products where product_gender='kids' order by product_id DESC limit 0,5";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
...
function changeBoysProductList($noofitem)
{
    if($noofitem == 'all')
        {
        $query="select product_id, product_name,product_price,product_code,product_image from incre_products where product_gender='boys' AND isActive='yes' order by product_id DESC   ";
    ...
    $query="select product_id, product_name,product_price,product_code,product_image from incre_products where product_gender='boys' AND isActive='yes' order by product_id DESC LIMIT 0,$noofitem  ";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
        }
}
...
{
   $query="select catogry_id,product_id,product_name,product_price,product_code,product_gender,product_quantity,product_image,prduct_description from incre_products where isActive='yes' AND product_id=$product_id";
    $result=mysql_query($query) or die(mysql_error());
    return $result;
}
