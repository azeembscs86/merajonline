...
<head>
   ...
   function NoOfItemslist(nooflist)
   {
			...
			xhr.open('GET','no_of_item_display.php?kidsitemshow='+nooflist,true);
			xhr.send();
 ...
 function Sorting(sortingtype)
   {            
                     var   totaldisplayitemnum = document.getElementById("nolistcount").value;
                        xhr =  new XMLHttpRequest();
			xhr.open('GET','sorting-item-page.php?sortingtypeval='+sortingtype+'&totalitemdisplay='+totaldisplayitemnum+'&kidssproduct=boyproduct',true);
			xhr.send();
                                            ...
                                            <div class="col-main">
                                                ...
                                                <div class="category-products">
                                                    <div class="toolbar">
                                                         ...
                                                         <?php
                                                $kids_wear_product=getKidssWearProducts();
                                                 $kids_wear_product_list=  mysql_fetch_array($kids_wear_product);
                                                 if($kids_wear_product_list['product_id'] != '')
                                                 { ?>
                                                        <div class="sorter">
                                                        ...
                                                        <li class="item col-md-3 col-sm-6 col-sms-6 col-smb-12 ">
                                                            <div class="item-inner">
                                                                <div class="box-images">
                                                                    <a class="product-image" title="Product Title 02" href="product-details?productid=<?php echo $kids_wear_product_list['product_id']; ?>">
                                                                ...
                                                                <div class="product-shop">
                                                                    <h2 class="product-name"><a title="Product Title 02" href="product-details?productid=<?php echo $kids_wear_product_list['product_id']; ?>"> <?php echo $kids_wear_product_list['product_name']; ?></a></h2>
