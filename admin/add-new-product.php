...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $web_title; ?>  | Admin | Product</title>
                ...
                <form role="form" method="post" action="addProduct.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <select name="clothing_type_id" id="clothing_type_id">
                          ...
                          if($clothing_types>0)
                          {
                            ...
                            {
                         ?>
                          <option value="<?php echo $clothing_type['catogry_id']; ?>"><?php echo $clothing_type['catogery_name']; ?></option> 
                          <?php
                            }
                          }
                          ?>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="product_code" class="form-control" id="product_code" placeholder="Enter product SKU code">
                    </div> 
