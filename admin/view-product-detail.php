...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?php echo $web_title; ?> | Admin | Prodcuts</title>
                  ...
                  <div class="table-responsive">
                    <table class="table no-margin">
                        ...
                        <tr>
                            ...
                            <td>
                                Seo Name:<?php echo $product['product_seo_name']; ?>
                            </td>                            
                        </tr>                       
                        
                        <tr>
                            <td colspan="2">
                                Description: <?php echo $product['prduct_description']; ?>
                            </td>
                        </tr>                        
                  ...
                  <div class="table-responsive">
                    <table class="table no-margin">
                      ...
                      <tbody>
                         ...
                         ?>
                          <tr>
                          <td><?php echo $topmenu['product_color_name']; ?></td>
                          <td>
                          ...
                          <td><div class="sparkbar" data-color="#00a65a" data-height="20"> <a href="edit-product-color.php?id=<?php echo $topmenu['product_color_id']; ?>">Edit</a> | <a href="delete-product-color.php?id=<?php echo $topmenu['product_color_id']; ?>" onclick='return confirmfunc()' >Delete</a></div></td>
                        </tr>
                          <?php
                              }
                          }
                  ...
                  <div class="table-responsive">
                    <table class="table no-margin">
                      ...
                      <tbody>
                         ...
                         ?>
                          <tr>
                          <td><?php echo $topmenus['product_size_name']; ?></td>
                                                
                          <td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo $topmenus['createdAt']; ?></div></td>
                          <td><div class="sparkbar" data-color="#00a65a" data-height="20"> <a href="edit-product-size.php?edit-size-id=<?php echo $topmenus['product_size_id']; ?>&pro_size_name=<?php echo $topmenus['product_size_name'];?>&product_idd=<?php echo $topmenus['product_id'];?>">Edit</a> | <a href="delete-size-product.php?id=<?php echo $topmenus['product_size_id']; ?>&product_idd=<?php echo $topmenus['product_id'];?>" onclick='return confirmfunc()' >Delete</a></div></td>
                        </tr>
                          <?php
                              }
                          }
